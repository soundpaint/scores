...
% meter      = ""
  ...
  arranger   = "Arr.: Jürgen Reuter (2025)"
...
sopranoLyrics_VerseI = \lyricmode {
  |
  Hei -- ßa, Ka -- |
  threi -- ner -- le, |
...
sopranoLyrics_VerseII = \lyricmode {
  Dreh' wie ein |
  Rä -- de -- le |
  flink dich im Tanz! |
  Flie -- gen die |
...
tenoreLyrics_VerseII = \lyricmode {
  Dreh' wie ein |
  Rä -- de -- le |
  flink dich im Tanz! |
  Flie -- gen die |
...
%      % TODO: Remove all ArticulationEvent objects from music
%      % expression such that the Note_performer will ignore them.
%    }
%  }
%}
...
\score {
  {
    ...
    \context ChoirStaff = choirStaff <<
      ...
      \context Lyrics = bassoLyrics_VerseI \lyricsto basso_VerseI { \bassoLyrics_VerseI }
    >>
  }
  \layout {
    indent = 0\cm
...
\score {
  {
    ...
    \context ChoirStaff = choirStaff <<
      ...
      \context Lyrics = bassoLyrics_VerseII \lyricsto basso_VerseII { \bassoLyrics_VerseII }
    >>
  }
  \layout {
    indent = 0\cm
